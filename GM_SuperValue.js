...
var GM_SuperValue = function() {
    ...
    this.set = function(varName, varValue) {
        ...
        switch (typeof varValue) {
            ...
            case 'object':
                ...
                */
                safeStr = JSON_MarkerStr + JSON.stringify(varValue);
    ...
    */
    this.get = function(varName, defaultValue) {
        ...
        if (typeof varValue == "string") {
            //--- Is it a JSON value?
            regxp = new RegExp('^' + JSON_MarkerStr + '(.+)$');
    ...
    */
    this.runTestCases = function(bUseConsole) {
        ...
        var dataBefore = [null, true, 1, 1.1, -1.0, 2.0E9, 2.77E9, 2.0E-9, 0xA9, 'string', [1, 2, 3], {
            a: 1,
            B: 2
        }, function() {
            a = 7;
            console.log("Neat! Ain't it?");
        }];
        var X;

        for (let J = 0; J <= dataBefore.length; J++) {
            X = dataBefore[J];
